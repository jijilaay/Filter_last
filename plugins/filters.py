    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b>🤝{m.from_user.mention}single developer vihanga from Rule Breakers ☺මෙන්න ඔයා හොයන අහවල්, {message.text}</b>",
        ...
        await message.reply_text(
                f"<b> 🤝{m.from_user.mention} single developer  ⁩ࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧvihanga ⁩ࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧ ⁩ࣧࣧࣧࣧࣧࣧࣧfrom Rule Breakers ☺මෙන්න ඔයා හොයන අහවල් {message.text}</b>",
                reply_markup=InlineKeyboardMarkup(buttons)
            )    
