...
async def filter(client: Bot, message: Message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        await message.reply_text(
                f"<b> 🤝(query.from_user.mention)single developer  ⁩ࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧvihanga ⁩ࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧ ⁩ࣧࣧࣧࣧࣧࣧࣧfrom Rule Breakers ☺මෙන්න ඔයා හොයන අහවල් {message.text}</b>",
                reply_markup=InlineKeyboardMarkup(buttons)
            )    
